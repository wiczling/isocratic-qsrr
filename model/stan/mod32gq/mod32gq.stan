...
matrix[nAnalyte_subset_10, 2] miu_corr_10;
  ...
  lprior += normal_lpdf(alpha | 0.50, 0.25);
...
model {
  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_1 | alpha*point_mu_lower_1, point_sd_lower_1);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_1) | to_vector(miu_corr_1), L_K_prec_1, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_2 | alpha*point_mu_lower_2, point_sd_lower_2);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_2) | to_vector(miu_corr_2), L_K_prec_2, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_3 | alpha*point_mu_lower_3, point_sd_lower_3);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_3) | to_vector(miu_corr_3), L_K_prec_3, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_4 | alpha*point_mu_lower_4, point_sd_lower_4);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_4) | to_vector(miu_corr_4), L_K_prec_4, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_5 | alpha*point_mu_lower_5, point_sd_lower_5);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_5) | to_vector(miu_corr_5), L_K_prec_5, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_6 | alpha*point_mu_lower_6, point_sd_lower_6);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_6) | to_vector(miu_corr_6), L_K_prec_6, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_7 | alpha*point_mu_lower_7, point_sd_lower_7);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_7) | to_vector(miu_corr_7), L_K_prec_7, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_8 | alpha*point_mu_lower_8, point_sd_lower_8);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_8) | to_vector(miu_corr_8), L_K_prec_8, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_9 | alpha*point_mu_lower_9, point_sd_lower_9);
 target += matrix_normal_prec_lpdf(to_vector(param_corr_9) | to_vector(miu_corr_9), L_K_prec_9, L_Omega);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_10 | alpha*point_mu_lower_10, point_sd_lower_10);
...
generated quantities {
 ...
 matrix[nAnalyte_subset_9, 2] param_corr_pop_9;
 matrix[nAnalyte_subset_10, 2] param_corr_pop_10;
  sS2Hat = S2Hat;
  sparam_ind = param;
...
matrix[nAnalyte_subset_9,nAnalyte_subset_9]  rho9 = L_K_prec_9 * L_K_prec_9';
matrix[nAnalyte_subset_10,nAnalyte_subset_10]  rho10 = L_K_prec_10 * L_K_prec_10';
...
sparam_pop[idx_corr[idx_corr_9],1:2]=param_corr_pop_9;
sparam_pop[idx_corr[idx_corr_10],1:2]=param_corr_pop_10;
