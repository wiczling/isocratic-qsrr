...
model {
 ...
 target += kronecker_normal_lpdf(to_vector(param_corr_2) | to_vector(miu_corr_2), L_K_prec_2, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_3 | point_mu_lower_3, point_sd_lower_3);
 target += kronecker_normal_lpdf(to_vector(param_corr_3) | to_vector(miu_corr_3), L_K_prec_3, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_4 | point_mu_lower_4, point_sd_lower_4);
 target += kronecker_normal_lpdf(to_vector(param_corr_4) | to_vector(miu_corr_4), L_K_prec_4, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_5 | point_mu_lower_5, point_sd_lower_5);
 target += kronecker_normal_lpdf(to_vector(param_corr_5) | to_vector(miu_corr_5), L_K_prec_5, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_6 | point_mu_lower_6, point_sd_lower_6);
 target += kronecker_normal_lpdf(to_vector(param_corr_6) | to_vector(miu_corr_6), L_K_prec_6, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_7 | point_mu_lower_7, point_sd_lower_7);
 target += kronecker_normal_lpdf(to_vector(param_corr_7) | to_vector(miu_corr_7), L_K_prec_7, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_8 | point_mu_lower_8, point_sd_lower_8);
 target += kronecker_normal_lpdf(to_vector(param_corr_8) | to_vector(miu_corr_8), L_K_prec_8, L_Omega_W);

  target += lkj_corr_cholesky_prec_point_lower_tri_lpdf(L_K_prec_9 | point_mu_lower_9, point_sd_lower_9);
 target += kronecker_normal_lpdf(to_vector(param_corr_9) | to_vector(miu_corr_9), L_K_prec_9, L_Omega_W);
