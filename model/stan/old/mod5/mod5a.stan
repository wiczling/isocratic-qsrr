...
transformed parameters {
  ...
  cholesky_factor_cov[2] L_Omega_t = cholesky_decompose(Omega*(nu-2+1));
...
model {
  ...
  target += inv_wishart_cholesky_lpdf(L_Omega_W | (nu+2-1), L_Omega_t);
  ...
  L_K_g =cholesky_decompose(identity_matrix(n_g));
