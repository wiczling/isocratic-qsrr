...
# mod5 <-  cmdstan_model(here::here(mod_model_dir, model_name_ext),
...
mod5cv <- cmdstan_model(here::here(mod_model_dir, model_name_ext), stanc_options = list("O1"))                
```
...
mod5cvgq <- cmdstan_model(here(modgq_model_dir,modelqg_name_ext))
fitcvgq  <- mod5cvgq$generate_quantities(fitcv,
                                          data = datastructcv,
                                          seed = 123,
                                          parallel_chains = 8,
                                          output_dir = modgq_output_dir,
