...
```{r summary}
fit$print(variables = c("logkwHat","S1Hat","beta","S2Hat","omega","rho[1,2]","sigma","sdpi"), max_rows=12)
```
...
<!-- similarity_ltri_rcdk_subset<-similarity_ltri_rcdk_df %>% filter(row!=col) -->
...
<!-- ```{r summary-cv} -->
<!-- fitcv$print(variables = c("logkwHat","S1Hat","beta","S2Hat","omega","rho[1,2]","sigma","sdpi"), max_rows=12) -->
<!-- ``` -->
