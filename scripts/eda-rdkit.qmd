...
mcs_params$BondCompareParameters$Compare <- rdFMCS$BondCompare$CompareOrderExact
...
pairs <- combn(seq_along(mols), 2, simplify = FALSE)
...
idadd<-which(comparison_table$to_add == "")
idremove<-which(comparison_table$to_remove == "")
