...
```{r}
extract_diff_fragments <- function(smiles1,smiles2, .mcs_params = mc_params, .fg_hierarchy = fg_hierarchy) {
...
foo <- extract_diff_fragments(smiles1, smiles2, mcs_params, fg_hierarchy)
