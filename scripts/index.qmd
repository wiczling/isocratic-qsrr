...
groupsA = (chargesA[,2:3]-chargesA[,1:2])         # acidic group
groupsB = -(chargesB[,2:3]-chargesB[,1:2])        # basic group
...
```{r summary}
fit$print(c("logkHat","beta","rho","omega", "pilogk1", 
            "pilogk2", "pilogk3", "pilogk4","pilogk5"), 
          max_rows = 180)
```
