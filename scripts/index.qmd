...
init <- function(){
  list(   logkwHat  = rnorm(1,2.2,2),
          ...
          etadlogkwA = matrix(0,nGroupsA,1),
          etadlogkwB = matrix(0,nGroupsB,1),
          etadS1A = matrix(0,nGroupsA,1),
          etadS1B = matrix(0,nGroupsB,1),
          etadlogkwA0 = matrix(0,nGroupsA,1),
          etadlogkwB0 = matrix(0,nGroupsB,1),
          etadS1A0 = matrix(0,nGroupsA,1),
          etadS1B0 = matrix(0,nGroupsB,1),
...
data_to_plot_diss <- data.frame(dlogkw, dS1,GroupType)

p<-ggpairs(data_to_plot_diss,columns = 1:2, columnLabels = c("dlogkw","dS1"),
