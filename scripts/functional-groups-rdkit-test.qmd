---
title: "Rdkit-based data preparation (test)"
author:
  - name: "Paweł Wiczling*"
    affiliations:
...
RDKit-based data preparation—including functional group identification, molecular descriptor calculation, and similarity matrix generation.
...
idx = c(14,521,887);
analytes_names = analytes_names %>% filter(ID%in%idx) %>%
...
smiles= smiles%>% filter(ID%in%idx) %>%
  mutate(ID = match(ID, unique(ID))) 


fg_selected = c("Primary_carbon", "Secondary_carbon", "Tertiary_carbon", "Quaternary_carbon", 
"Alkene", "Alkyne", "Alkylchloride", "Alkylfluoride", "Alkylbromide", 
"Primary_alcohol", "Secondary_alcohol", "Tertiary_alcohol", "Dialkylether", 
"Dialkylthioether", "Alkylarylether", "Diarylether", "Alkylarylthioether", 
"Diarylthioether", "Primary_aliph_amine", "Secondary_aliph_amine", 
"Tertiary_aliph_amine", "Quaternary_aliph_ammonium", "Primary_arom_amine", 
"Secondary_arom_amine", "Secondary_mixed_amine", "Tertiary_mixed_amine", 
"Quaternary_mixed_ammonium", "Disulfide", "X1.2.Aminoalcohol", 
"X1.2.Diol", "Organometallic_compounds", "Aldehyde", "Ketone", 
"Imine", "Immonium", "Oximether", "Acetal", "Hemiacetal", "Aminal", 
"Halogen_acetal_like", "Acetal_like", "NOS_methylen_ester_and_similar", 
"Hetero_methylen_ester_and_similar", "Cyanhydrine", "Chloroalkene", 
"Bromoalkene", "Enol", "Enolether", "Enolester", "Enamine", "Thioenolether", 
"Carboxylic_acid", "Carboxylic_ester", "Lactone", "Carbothioic_S_ester", 
"Primary_amide", "Secondary_amide", "Tertiary_amide", "Lactam", 
"Alkyl_imide", "Imide_acidic", "Thioamide", "Amidine", "Hydroxamic_acid", 
"Hydroxamic_acid_ester", "Imidoacid", "Imidoacid_cyclic", "Imidolactone", 
"Imidothiolactone", "Imidolactam", "Imidoylhalide_cyclic", "Alpha_aminoacid", 
"Alpha_hydroxyacid", "Peptide_middle", "Peptide_C_term", "Peptide_N_term", 
"Ketenacetal", "Nitrile", "Carbonic_acid_dieester", "Urea", "Thiourea", 
"Isourea", "Isothiourea", "Guanidine", "Urethan", "Semicarbazide", 
"Semicarbazone", "Isothiocyanate", "Phenol", "X1.2.Diphenol", 
"Arylchloride", "Arylfluoride", "Arylbromide", "Aryliodide", 
"Arylthiol", "Iminoarene", "Oxoarene", "Hetero_N_basic_H", "Hetero_N_basic_no_H", 
"Hetero_N_nonbasic", "Hetero_O", "Hetero_S", "Heteroaromatic", 
"Thionitrite", "Nitro", "Nitroso", "Azide", "Nitrosamide", "N.Oxide", 
"Hydrazine", "Hydrazone", "Sulfon", "Sulfoxide", "Sulfuric_diamide", 
"Sulfuric_esteramide", "Sulfonic_acid", "Sulfonamide", "Sulfonic_halide", 
"Phosphonic_acid", "Phosphonic_diester", "Phosphoric_diester", 
"Phosphoric_triester", "Phosphoric_diestermonoamide", "Phosphoric_monoesterdiamide", 
"Quart_silane", "Het_trialkylsilane", "Aromatic", "Heterocyclic", 
"Epoxide", "Spiro", "Annelated_rings", "Bridged_rings", "Sugar_pattern_1", 
"Sugar_pattern_2", "Sugar_pattern_2_reducing", "Conjugated_double_bond", 
"Conjugated_tripple_bond", "Mixed_anhydrides", "Halogen_on_hetero", 
"Halogen_multi_subst", "Trifluoromethyl", "CH.acidic", "CH.acidic_strong"
)
```
...
functional_groups <- analyze_smiles_vector(smiles$smiles)
colnames(functional_groups) <- make.names(colnames(functional_groups))
functional_groups<-functional_groups %>% select(all_of(fg_selected))
```
