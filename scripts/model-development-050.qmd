...
```{r mcmc-intervals}
p1 <- mcmc_intervals(fit$draws(c("logkwHat","S1Hat","dlogkwHat","dS1Hat","beta[1]","beta[2]","S2Hat")))+ scale_y_discrete(labels = c( "logkwHat"= expression(theta[logkw]),
                   ...
                   limits = t(rev(c("logkwHat",
                               ...
                               "beta[2]",
                               "S2Hat"))))
p2 <- mcmc_intervals(fit$draws(c("omega[1]","omega[2]","sigma","sdpi[1]","sdpi[2]","sdpi[3]","sdpi[4]", "alpha")))+ scale_y_discrete(labels = c(  "omega[1]"=expression(omega[logkw]),
                              "omega[2]"=expression(omega[S1]),
                              "sigma"= expression(sigma),
                              "sdpi[1]"= expression(kappa[1][logkw]), 
                              "sdpi[2]"= expression(kappa[1][S1]),
                              "sdpi[3]"= expression(kappa[2][logkw]),
                              "sdpi[4]"= expression(kappa[2][S1]),
