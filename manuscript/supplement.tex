...
\hline
$\theta_{logkw}$ & 3.05 & 3.05 & 0.19 & 0.19 & 2.74 & 3.36 & 1.00\\
\hline
$\theta_{S1}$ & 3.67 & 3.67 & 0.16 & 0.16 & 3.40 & 3.94 & 1.00\\
\hline
$\theta_{dlogkw}$ & -0.35 & -0.35 & 0.12 & 0.12 & -0.55 & -0.15 & 1.00\\
\hline
$\theta_{dS1}$ & 0.30 & 0.30 & 0.09 & 0.09 & 0.16 & 0.45 & 1.00\\
\hline
$\beta_{logkw}$ & 0.86 & 0.86 & 0.05 & 0.06 & 0.77 & 0.95 & 1.00\\
\hline
$\beta_{S1}$ & 0.62 & 0.62 & 0.05 & 0.05 & 0.54 & 0.70 & 1.00\\
\hline
$\theta_{S2}$ & 2.90 & 2.90 & 0.03 & 0.03 & 2.85 & 2.95 & 1.02\\
\hline
$\omega_{logkw}$ & 1.41 & 1.41 & 0.04 & 0.04 & 1.35 & 1.47 & 1.00\\
\hline
$\omega_{S1}$ & 1.13 & 1.13 & 0.03 & 0.03 & 1.08 & 1.18 & 1.00\\
\hline
$\rho_{1,2}$ & 0.88 & 0.88 & 0.01 & 0.01 & 0.87 & 0.90 & 1.00\\
\hline
$\sigma$ & 0.05 & 0.05 & 0.00 & 0.00 & 0.05 & 0.05 & 1.00\\
\hline
$\alpha$ & 0.71 & 0.71 & 0.04 & 0.04 & 0.64 & 0.77 & 1.00\\
\hline
$\kappa1_{logkw}$ & 0.15 & 0.14 & 0.02 & 0.02 & 0.11 & 0.18 & 1.01\\
\hline
$\kappa1_{S1}$ & 0.13 & 0.13 & 0.02 & 0.02 & 0.10 & 0.17 & 1.01\\
\hline
$\kappa2_{logkw}$ & 0.34 & 0.33 & 0.06 & 0.06 & 0.23 & 0.44 & 1.00\\
\hline
$\kappa2_{S1}$ & 0.19 & 0.18 & 0.07 & 0.07 & 0.08 & 0.30 & 1.01\\
\hline
\end{tabular}

mean denotes the posterior mean; median denotes the posterior median, sd
denotes the posterior standard deviation; mad denotes the median
absolute deviation; q5 denotes the 5th percentile of the posterior
draws; q95 denotes the 95th percentile of the posterior draws; rhat
denotes the Gelman--Rubin convergence diagnostic. Values close to 1.0
indicate that the MCMC chains have mixed and converged well.
...
\hypertarget{figure-s2.-matrix-normal-distribution}{%
\section{Figure S2. Matrix Normal
Distribution}\label{figure-s2.-matrix-normal-distribution}}

Simulations from the Matrix Normal Distribution with row correlations of
0.9 and column correlation of 0.75. \[
\begin{bmatrix}
\text{log}k_{w1} & S_1 \\
\text{log}k_{w2} & S_2
\end{bmatrix}
...
\includegraphics{../deliv/figures/manuscript/supplement/matrix-normal.png}

\newpage{}

\hypertarget{figure-s3.-functional-group-effects}{%
\section{Figure S3. Functional group
effects}\label{figure-s3.-functional-group-effects}}
...
groups. The least common functional groups (\textless=10 across all
...
\hypertarget{figure-s6.-goodness-of-fit-plots-gof}{%
\section{Figure S6. Goodness of fit plots
(GOF)}\label{figure-s6.-goodness-of-fit-plots-gof}}
...
\hypertarget{figure-s7.-example-illustrating-model-application}{%
\section{Figure S7. Example illustrating model
application}\label{figure-s7.-example-illustrating-model-application}}

The green area represents individual prediction given the model and
experimental data shown in red and assuming no structural similarity.
The purple area includes similarity matrix in predictions. The available
observations are presented as closed white symbols. Both the logk and k
are shown for comparison.

\includegraphics{../deliv/figures/manuscript/supplement/compare2.pdf}
...
loaded via a namespace (and not attached):
 ...
 [7] scales_1.3.0         textshaping_0.4.0    yaml_2.3.10         
